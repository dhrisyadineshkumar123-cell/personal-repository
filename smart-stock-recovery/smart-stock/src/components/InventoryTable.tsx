...
const mockProducts: Product[] = [
  { id: "1", name: "India Gate Basmati Rice 5kg", sku: "RIC-001", category: "Grains", currentStock: 342, reorderPoint: 100, optimalStock: 400, unitCost: 450.00, status: "optimal" },
  { id: "2", name: "Tata Salt 1kg", sku: "SLT-023", category: "Condiments", currentStock: 45, reorderPoint: 80, optimalStock: 200, unitCost: 28.00, status: "low" },
  { id: "3", name: "Aashirvaad Atta 10kg", sku: "WHT-112", category: "Grains", currentStock: 12, reorderPoint: 50, optimalStock: 150, unitCost: 380.00, status: "critical" },
  { id: "4", name: "Amul Taaza Milk 1L", sku: "MLK-045", category: "Dairy", currentStock: 580, reorderPoint: 100, optimalStock: 300, unitCost: 66.00, status: "overstock" },
  { id: "5", name: "Everest Sabji Masala 100g", sku: "SPC-067", category: "Spices", currentStock: 198, reorderPoint: 75, optimalStock: 250, unitCost: 52.00, status: "optimal" },
  { id: "6", name: "Toor Dal (Premium) 1kg", sku: "DAL-034", category: "Grains", currentStock: 28, reorderPoint: 60, optimalStock: 180, unitCost: 160.00, status: "low" },
  { id: "7", name: "Nandini Ghee 500ml", sku: "GHE-089", category: "Dairy", currentStock: 8, reorderPoint: 40, optimalStock: 120, unitCost: 295.00, status: "critical" },
  { id: "8", name: "Parle-G Gold 1kg", sku: "BSK-012", category: "Snacks", currentStock: 445, reorderPoint: 80, optimalStock: 200, unitCost: 120.00, status: "overstock" },
];
              ...
              return (
                <tr key={product.id} className="hover:bg-white/5 transition-colors group/row">
                  ...
                  <td className="py-4 px-6">
                    <Badge variant="outline" className={`font-semibold ${statusConfig[product.status].className}`}>
