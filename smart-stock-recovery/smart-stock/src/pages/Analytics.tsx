...
const Analytics = () => {
  const kpis = [
    { label: "Total SKUs", value: "124", change: "+8 this month", color: "text-[#8b5cf6]", bg: "bg-[#8b5cf6]/20", shadow: "shadow-[0_0_15px_rgba(139,92,246,0.3)]" },
    { label: "Stock value", value: "$42,380", change: "+3.1% vs last month", color: "text-[#10b981]", bg: "bg-[#10b981]/20", shadow: "shadow-[0_0_15px_rgba(16,185,129,0.3)]" },
    { label: "Low / critical items", value: "9", change: "5 low • 4 critical", color: "text-[#ef4444]", bg: "bg-[#ef4444]/20", shadow: "shadow-[0_0_15px_rgba(239,68,68,0.3)]" },
    { label: "Overstocked items", value: "6", change: "Tied up capital: $3,210", color: "text-[#3b82f6]", bg: "bg-[#3b82f6]/20", shadow: "shadow-[0_0_15px_rgba(59,130,246,0.3)]" }
  ];
  ...
  const stockMix = [
    { label: "Optimal stock", value: 68, color: "bg-success shadow-[0_0_10px_rgba(16,185,129,0.8)]" },
    { label: "Low / critical", value: 17, color: "bg-warning shadow-[0_0_10px_rgba(245,158,11,0.8)]" },
    { label: "Overstock", value: 15, color: "bg-info shadow-[0_0_10px_rgba(59,130,246,0.8)]" }
  ];
